...
test('page modules declare page-owned callback contracts', () => {
  const pages = {
    ...
    bodycams: ['cortex_mdt:getBodycams', 'cortex_mdt:viewBodycam', 'cortex_mdt:getLiveFeeds', 'cortex_mdt:viewLiveFeed'],
    fto: ['cortex_mdt:getFtoRecords', 'cortex_mdt:createFtoRecord', 'cortex_mdt:updateFtoRecord'],
    sops: ['cortex_mdt:getSops'],
    command: ['cortex_mdt:getFeatureRecords', 'cortex_mdt:createFeatureRecord', 'cortex_mdt:updateFeatureRecord', 'cortex_mdt:deleteFeatureRecord', 'cortex_mdt:acknowledgeSop', 'cortex_mdt:submitPublicComplaint'],
